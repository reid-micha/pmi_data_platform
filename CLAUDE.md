...
>
> 本檔（§1–§14）保留為**設計權威**（為什麼這樣設計）；**實作狀態**看 §15 的 2026-05-29 snapshot 跟
> [`TODO-跑出來.md`](TODO-跑出來.md) / [`TODO-跑得對.md`](TODO-跑得對.md)（每週更新）。
...
## 15. 現況（Current State, 2026-05-29 snapshot）
...
>
> 細節 TODO 不在這裡列，請看 [`TODO-跑出來.md`](TODO-跑出來.md) 跟 [`TODO-跑得對.md`](TODO-跑得對.md)。
>
